...
export const STORAGE_KEY = "prithvi-site-content-v8";
...
export const LOGO = (name: string) => `/logos/${name}_favicon.png`;
export const SHOT = (name: string) => `/screenshots/${name}.png`;
...
export const WRITING: LinkListItem[] = [
  { cursor: "pen", title: "the buildspace experience", meta: "jun 2024", href: "https://prithvibharadwaj.substack.com/p/the-buildspace-experience", favicon: LOGO("substack") },
  { cursor: "pen", title: "antigravity IDE for unity", meta: "may 2024", href: "https://medium.com/@prithvibofficial/how-to-use-antigravity-in-unity-for-game-development-8da2cbc353cb", favicon: "/logos/medium.svg" },
  { cursor: "pen", title: "how to use cursor AI with unity", meta: "feb 2024", href: "https://medium.com/@prithvibofficial/how-to-use-cursor-ai-with-unity-a32291f9e852", favicon: "/logos/medium.svg" },
  { cursor: "pen", title: "building & skiving", meta: "jan 2024", href: "https://prithvibharadwaj.substack.com/p/building-and-skiving", favicon: LOGO("substack") },
  { cursor: "pen", title: "looking back at 2023", meta: "jan 2024", href: "https://prithvibharadwaj.substack.com/p/looking-back-at-2023", favicon: LOGO("substack") },
  { cursor: "pen", title: "travel, timepass and being in the trenches", meta: "dec 2023", href: "https://prithvibharadwaj.substack.com/p/travel-timepass-and-being-in-the", favicon: LOGO("substack") },
  { cursor: "pen", title: "i might have overcorrected", meta: "nov 2023", href: "https://prithvibharadwaj.substack.com/p/i-might-have-overcorrected", favicon: LOGO("substack") },
  { cursor: "pen", title: "the philosophy behind \"asjbdhjasdfhgw\"", meta: "nov 2023", href: "https://prithvibharadwaj.substack.com/p/the-philosophy-behind-asjbdhjasdfhgw", favicon: LOGO("substack") },
];
...
export const COLUMN = "w-full max-w-[min(42rem,78vw)] mx-auto md:ml-[15vw] lg:ml-[18vw] scroll-mt-12";
