      ...
      <div className="space-y-4">
        ...
        {!expanded && (
          <p>
            <button
              onClick={expand}
              className="text-(--ink)/40 hover:text-(--ink)/70 transition-colors duration-200 cursor-pointer inline"
              style={{
                background: "none",
                border: "none",
                padding: 0,
      ...
      {expanded && (
        <div className="mt-8">
          ...
          <p className="mt-12">
            <button
              onClick={collapse}
              className="text-(--ink)/30 hover:text-(--ink)/60 transition-colors duration-200 cursor-pointer text-xs"
              style={{
                background: "none",
                border: "none",
                padding: 0,
